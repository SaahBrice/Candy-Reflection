...
var mirror_properties1
var mirror_properties2
var mirror_properties3
...
func _ready() -> void:
	...
	mirror_properties1 = Matrix.mirror_position(matrix_width,matrix_height)
	mirror_properties2 = Matrix.mirror_position(matrix_width,matrix_height)
	mirror_properties3 = Matrix.mirror_position(matrix_width,matrix_height)
	while mirror_properties1 == mirror_properties  and mirror_properties == mirror_properties2 and mirror_properties == mirror_properties3:
		mirror_properties = Matrix.mirror_position(matrix_width,matrix_height)
		mirror_properties1 = Matrix.mirror_position(matrix_width,matrix_height)
		mirror_properties2 = Matrix.mirror_position(matrix_width,matrix_height)
		mirror_properties3 = Matrix.mirror_position(matrix_width,matrix_height)
	...
	print_out_mirror(mirror_properties1[0],mirror_properties1[1],mirror_properties1[2],mirror_properties1[3], 1)
	print_out_mirror(mirror_properties2[0],mirror_properties2[1],mirror_properties2[2],mirror_properties2[3], 2)
	print_out_mirror(mirror_properties3[0],mirror_properties3[1],mirror_properties3[2],mirror_properties3[3], 3)
	get_segments(mirror_properties[0],mirror_properties[1],mirror_properties[2],mirror_properties[3], 0)
	get_segments(mirror_properties1[0],mirror_properties1[1],mirror_properties1[2],mirror_properties1[3], 1)
	get_segments(mirror_properties2[0],mirror_properties2[1],mirror_properties2[2],mirror_properties2[3], 2)
	get_segments(mirror_properties3[0],mirror_properties3[1],mirror_properties3[2],mirror_properties3[3], 3)
	count_1_hints()
...
func reload_till_get_possibility_to_reflect(mirror_position_h,mirror_position_w,mirror_axis,mirror_size, mirror_number):
	if mirror_number==0:
		...
		mirror_size=1
		mirror_properties = Matrix.mirror_position(matrix_width,matrix_height)
		while mirror_properties == mirror_properties1:
			mirror_properties = Matrix.mirror_position(matrix_width,matrix_height)
		mirror_position_h=mirror_properties[0]
		mirror_position_w=mirror_properties[1]
		mirror_axis=mirror_properties[2]
		...
		mirror_size=1
		mirror_properties1 = Matrix.mirror_position(matrix_width,matrix_height)
		while mirror_properties1 == mirror_properties:
			mirror_properties1 = Matrix.mirror_position(matrix_width,matrix_height)
		mirror_position_h=mirror_properties1[0]
		mirror_position_w=mirror_properties1[1]
		mirror_axis=mirror_properties1[2]
		mirror_size=mirror_properties1[3]
		print_out_mirror(mirror_position_h,mirror_position_w,mirror_axis,mirror_size, mirror_number)
		get_segments(mirror_position_h,mirror_position_w,mirror_axis,mirror_size, 1)
	elif mirror_number == 2:
		mirror = $mirror3
		mirror.scale.y =1
		mirror.scale.x = 1
		...
		mirror_size=1
		mirror_properties2 = Matrix.mirror_position(matrix_width,matrix_height)
		while mirror_properties1 == mirror_properties and mirror_properties== mirror_properties2:
			mirror_properties2 = Matrix.mirror_position(matrix_width,matrix_height)
		mirror_position_h=mirror_properties2[0]
		mirror_position_w=mirror_properties2[1]
		mirror_axis=mirror_properties2[2]
		mirror_size=mirror_properties2[3]
		print_out_mirror(mirror_position_h,mirror_position_w,mirror_axis,mirror_size, mirror_number)
		get_segments(mirror_position_h,mirror_position_w,mirror_axis,mirror_size, 2)
		...
		mirror_size=1
		mirror_properties3 = Matrix.mirror_position(matrix_width,matrix_height)
		while mirror_properties3 == mirror_properties and mirror_properties== mirror_properties2:
			mirror_properties3 = Matrix.mirror_position(matrix_width,matrix_height)
		mirror_position_h=mirror_properties3[0]
		mirror_position_w=mirror_properties3[1]
		mirror_axis=mirror_properties3[2]
		mirror_size=mirror_properties3[3]
		print_out_mirror(mirror_position_h,mirror_position_w,mirror_axis,mirror_size, mirror_number)
		get_segments(mirror_position_h,mirror_position_w,mirror_axis,mirror_size, 3)
...
func check_validity():
	if test_matrix == solution[0]:
		...
		if number_of_swaps<Total_number_of_swaps:
			...
			reload_till_get_possibility_to_reflect(mirror_properties1[0],mirror_properties1[1],mirror_properties1[2],mirror_properties1[3], 1)
			reload_till_get_possibility_to_reflect(mirror_properties2[0],mirror_properties2[1],mirror_properties2[2],mirror_properties2[3], 2)
			reload_till_get_possibility_to_reflect(mirror_properties3[0],mirror_properties3[1],mirror_properties3[2],mirror_properties3[3], 3)
			count_1_hints()
...
func count_1_hints():
	...
	solution = Matrix.game_player_4_mirrors(one_zero, origine, mirror_properties, mirror_properties1,mirror_properties2, mirror_properties3)
